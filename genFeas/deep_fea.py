...
def set_args():
    ...
    parser.add_argument('--roi_dir',         type=str,   default="../data/ThyroidS3/ImgsROI")
    parser.add_argument('--fea_dir',         type=str,   default="../data/ThyroidS3/FeasROI/L2Feas")
    parser.add_argument('--model_name',      type=str,   default="inceptionv3")
    parser.add_argument('--model_path',      type=str,   default="Thyroid06-0.8732.pth")
...
if __name__ == '__main__':
    ...
    gen_deep_features(args.roi_dir, args.fea_dir, args.data_mode, ft_model, args)
